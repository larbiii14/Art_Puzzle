...
class _AppState extends State<App> {
  ...
  void initState() {
    ...
    _timer = Timer(const Duration(milliseconds: 20), () {
      ...
      precacheImage(
        Image.asset('assets/images/dashatar/gallery/the_screem.png').image,
        context,
      );
      precacheImage(
        Image.asset('assets/images/dashatar/success/the_screem.png').image,
        context,
      );
      precacheImage(
        Image.asset('assets/images/dashatar/gallery/mona_lisa.png').image,
        context,
      );
      precacheImage(
        Image.asset('assets/images/dashatar/success/mona_lisa.png').image,
        context,
      );
      precacheImage(
        Image.asset(
                'assets/images/dashatar/gallery/girl_with_pearl_earring.png')
            .image,
        context,
      );
      precacheImage(
        Image.asset(
                'assets/images/dashatar/success/girl_with_pearl_earring.png')
            .image,
        context,
      );
      precacheImage(
      ...
      precacheImage(
        Image.asset('assets/images/simple_art_large.png').image,
        context,
      );
      precacheImage(
        Image.asset('assets/images/simple_art_medium.png').image,
        context,
      );
      precacheImage(
        Image.asset('assets/images/simple_art_small.png').image,
        context,
      );
      precacheImage(
